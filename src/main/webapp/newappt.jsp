...
<main role="main" class="container">
    <h1 class="mt-5">New Appointment</h1>
    <form action="appt" method="post">
        <div class="form-group">
            <label for="owner">Appt. Book's Owner</label>
        ...
        <div class="form-group">
            ...
            <input name="edate"  id="edate" class="form-control" type="date" required>
            <input name="etime"  id="etime" class="form-control" type="time" required>
        </div>

        <input name="newappt" type="submit" value="Create">
    </form>
</main>
